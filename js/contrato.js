 ...
 if (tipo === 'epi') {
        ...
        <div style="text-align: justify; font-size: 12pt; line-height: 1.6;">
            ...
            <p style="text-indent: 30px; margin-bottom: 10px;"><strong>1.</strong> O presente contrato tem como objeto a prestação de serviços para execução integral do <strong>FORNECIMENTO DE MÃO DE OBRA PRÓPRIA OU INDICADA PARA EXECUÇÃO FECHAMENTO DE REBOCO INTERNO, EXECUÇÃO DE CAIXAS PLUVIAIS DE ALVENARIA, ALVENARIA DE PLATIMBANDA, REVESTIMENTO DE BANHEIRO, REVESTIMENTO DE PAREDE INTERNA E EXTERNA, EXECUÇÃO DE PASSEIO E EXECUÇÃO PISO DE CONCRETO</strong>, em obra de construção da <strong>${enderecoObra}</strong> situada na cidade de Jataí no estado de Goiás, a serem executados pelo CONTRATADO, conforme os termos que se determinam a seguir:</p>
